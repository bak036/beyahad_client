...
const CreditCardComponent: React.FC<Props> = ({
	history,
	setAccess,
	onPay,
	addedValidations,
	...
	const validate = () => {
		...
		if (!disableNumOfPayments) {
			if (
				...
				setNumOfPaymentError(Lang.format('NeedInsertNumOfPayment'))
				retVal = false;
			}
		}
		if (
			...
			setCardValidDateMonthError(Lang.format('ThisMonthIsNotValid'))
			retVal = false;
		}
		...
		<div className='payment-form'>
			<div className='payment-form-content'>
				...
				{!isDischarge && <>
					<div className='attention-container'>
						<CustomSpan classNameSpan='attention-text orange' text={`לתשומת ליבך!`} />
					</div>
						...
						{saveCard && (
							<div className='save-short-code-inputs-container'>
								<div className='code-container'>
									<CustomInputText
										labelText={'בחר קוד מקוצר (5 ספרות)'}
			...
			<div className='payment-btn'>
				<CustomButton
					...
					onClick={isDischarge ? onDischarge : sendPaymnetClicked}
				/>
			</div>
		</div>
	);
...
export default observer(CreditCardComponent);
