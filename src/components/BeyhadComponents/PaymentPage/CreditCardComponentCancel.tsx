...
const CreditCardComponentCancel: React.FC<Props> = ({
	history,
	setAccess,
	onPay,
	addedValidations,
	...
	const forgotCodeVar = forgotCode ? forgotCode : false;
	const allowZeroPriceVar = allowZeroPrice ? allowZeroPrice : false;
	...
	return (
		<div className='payment-form-cancel'>
			<div className='customer-details-cancel'>
				<span className='title'>פרטי הלקוח</span>
				<div className='row-customer-details'>
					<div className='firstName-detail column'>
						<CustomInputText
							labelText={Lang.format('FirstName')}
							value={creditCardStore.creditCardDetails.ownerFirstName}
							onChange={onFirstNameChanged}
							error={firstNameError}
							disabled={disableFirstAndLastNameVar}
						/>
					</div>
					<div className='lastName-detail column'>
						<CustomInputText
					...
					<div className='phone-detail column'>
			...
			{!allowZeroPrice && (
				<div className='credit-card-details-for-cancel column'>
					<span className='title'>פרטי כרטיס אשראי לזיכוי</span>
					<div className='cancel-details-box'>
						<div className='credit-card-detail ' >
							...
							<CustomMediaQuery.Desktop>
								<span className='propertys-credit-card'>*ניתן לזכות כל כרטיס אשראי על שם בעל המועדון</span>
							</CustomMediaQuery.Desktop>
						</div>
						<div className='id-detail column'>
							<CustomInputText
								required
						...
						<div className='validation-card-with-payments'>
							<div className='validation-card column'>
			...
			<div className='payment-btn'>
				<div className='agree-with-forgot'>
					{!isDischarge && forgotCode && !allowZeroPrice && (
						<div className='agreement-container'>
							{creditCardStore.authStore.currentUser.hasPinCode && (
								<>
...
export default observer(CreditCardComponentCancel);
